...
contract Mobius is ERC20, Ownable {
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "MOBIUS: _addMinter is the zero address");
    ...
    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "MOBIUS: _delMinter is the zero address");
        if (minters.length > 0) {
